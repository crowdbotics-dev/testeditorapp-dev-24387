...
## Project Structure
    ...
    ├── testeditorapp_dev_24387  # Django project configurations
...
1. Clone this repo and `cd testeditorapp_dev_24387`
...
2. Clone this repo and `cd testeditorapp_dev_24387`
